class Data:
    ...
    test_data_user0 = ['Космо', 'Хилл', 'улица Беговая, 25', 'Университет', '+79998887766', '05.06.2024', 'В качестве оплаты отдам старый']
    test_data_user1 = ['Альбус Вульфрик', 'Дамблдор', 'Хогвартс', 'Сокол', '+799988877665', '25.06.2024',
